...
$m['chai/chai'] = { exports: {} };
(function(f){if(typeof $m['chai/chai'].exports==="object"&&typeof $m['chai/chai']!=="undefined"){$m['chai/chai'].exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.chai = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var liblayer__matcher = $m['path-to-regexp'].exports;
var liblayer__urlUtils = $m['@yr/url-utils'].exports;

var liblayer__Layer = function () {
  /**
   * Constructor
   * @param {String} path
   * @param {Function} fn
  ...
  Layer.prototype.match = function match(path) {
    ...
    for (var i = 1, len = mtch.length; i < len; ++i) {
      key = this.keys[i - 1];
      val = liblayer__urlUtils.decode(mtch[i]);
...
var librouter__debug = librouter__Debug('express:router');

var librouter__Router = function () {
  /**
   * Constructor
   * @param {Object} [options]
   */
  ...
  Router.prototype.method = function method(path) {
    ...
    fns.forEach(function (fn) {
      var lyr = librouter__layer(path, fn, _this2.strictMatcherOpts);

      lyr.route = true;

      librouter__debug('adding router route %s with path %s', lyr.name, path);
...
var libresponse__Response = function (_Emitter) {
  ...
  Response.prototype.cookie = function cookie(name, val, options) {
    ...
    document.cookie = libresponse__cookieLib.serialize(name, String(val), options);
  ...
  Response.prototype.abort = function abort() {
...
/*== lib/request.js ==*/
$m['lib/request'] = { exports: {} };

var librequest__cookieLib = $m['cookie'].exports;
var librequest__Emitter = $m['eventemitter3'].exports;
var librequest__qsParse = $m['query-string'].exports.parse;
var librequest__urlUtils = $m['@yr/url-utils'].exports;

var librequest__RE_SPLIT = /[?#]/;

var librequest__Request = function (_Emitter) {
  ...
  function Request(url, bootstrap) {
    ...
    url = url ? librequest__urlUtils.encode(url) : librequest__urlUtils.getCurrent();

    var path = url.split(librequest__RE_SPLIT);
    ...
    _this.cached = false;
    _this.cookies = librequest__cookieLib.parse(document.cookie);
    _this.hash = librequest__qsParse(hash);
    _this.params = null;
    _this.path = librequest__urlUtils.sanitize(path[0]);
    _this.query = librequest__qsParse(qs);
  ...
  Request.prototype.reset = function reset(bootstrap) {
    ...
    this.cached = false;
    this.path = librequest__urlUtils.sanitize(this.originalUrl.split('?')[0]);
    this.params = null;
    this.reloaded = false;
  };
...
/*== lib/history.js ==*/
$m['lib/history'] = { exports: {} };

var libhistory__debugFactory = $m['debug'].exports;
var libhistory__urlUtils = $m['@yr/url-utils'].exports;

var libhistory__debug = libhistory__debugFactory('express:history');
var libhistory__bootstrap = true;

var libhistory__History = function () {
  /**
   * Constructor
  ...
  History.prototype.listen = function listen() {
    ...
    if (libhistory__hasHistory()) {
      ...
      libhistory__debug('listening with history API');
    }
  ...
  History.prototype.navigateTo = function navigateTo(url, title, isUpdate, noScroll) {
    ...
    if (url !== libhistory__urlUtils.getCurrent()) {
      if (this.running) {
        ...
        libhistory__debug('navigate to: %s', url);
  ...
  History.prototype.redirectTo = function redirectTo(url) {
    this.destroy();
    window.location = libhistory__urlUtils.encode(url);
  };
  ...
  History.prototype.handle = function handle(url) {
    ...
    url = url ? libhistory__urlUtils.encode(url) : libhistory__urlUtils.getCurrent();
    // Error encoding url
    if (!url) {
    ...
    if (this.cache[url]) {
      ...
      req.reloaded = false;
      libhistory__debug('context retrieved from cache: %s', url);
    } else {
      req = this.request(url, libhistory__bootstrap);
      res = this.response(req);
      libhistory__debug('generating new context: %s', url);
    }
    res.req = req;
    ctx.req = req;
    ctx.res = res;
    ...
    if (!libhistory__bootstrap && !noScroll) {
      window.scrollTo(0, 0);
    }
  ...
  History.prototype.onClick = function onClick(evt) {
    ...
    var isSameAsCurrent = path === libhistory__urlUtils.getCurrent();
...
function libhistory__hasHistory() {
 ...
 * @returns {Boolean}
 */
function libhistory__sameOrigin(url) {
...
/*== lib/application.js ==*/
$m['lib/application'] = { exports: {} };

var libapplication__debugFactory = $m['debug'].exports;
var libapplication__Emitter = $m['eventemitter3'].exports;
var libapplication__history = $m['lib/history'].exports;
var libapplication__request = $m['lib/request'].exports;
var libapplication__response = $m['lib/response'].exports;
var libapplication__router = $m['lib/router'].exports;

var libapplication__NOOP = function NOOP() {};

var libapplication__debug = libapplication__debugFactory('express:application');

var libapplication__Application = function (_Emitter) {
  ...
  function Application() {
    ...
    var requestFactory = function requestFactory(url, bootstrap) {
      var req = libapplication__request(url, bootstrap);

      req.app = app;
      return req;
    };
    var responseFactory = function responseFactory() {
      var res = libapplication__response();
...
var yrexpressclient___require = $m['lib/request'].exports,
    yrexpressclient__Request = yrexpressclient___require.Request;

var yrexpressclient___require2 = $m['lib/response'].exports,
    yrexpressclient__Response = yrexpressclient___require2.Response;

var yrexpressclient__application = $m['lib/application'].exports;
var yrexpressclient__Router = $m['lib/router'].exports;

/**
 * Application factory
 * @returns {Application}
 */
$m['@yr/express-client'].exports = function createApplication() {
  return yrexpressclient__application();
};
...
describe('express-client', function () {
  describe('application factory', function () {
    it('should store the app instance on the request/response instance', function () {
      ...
      testsrctest__expect(req.app).to.equal(app);
    });
  });
  ...
  describe('router', function () {
    describe('use()', function () {
      ...
      it('should register multiple middleware functions at a specified path', function () {
        ...
        testsrctest__expect(router.stack[0].regexp.exec(path)).to.exist;
        testsrctest__expect(router.stack[0]).to.have.property('fn', fn1);
        testsrctest__expect(router.stack[1].regexp.exec(path)).to.exist;
        testsrctest__expect(router.stack[1]).to.have.property('fn', fn2);
      });
    });
    ...
    describe('handle()', function () {
      ...
      it('should allow middleware to be mounted under a specific path', function () {
        ...
        var fn = function fn(req, res, next) {
          count++;
          testsrctest__expect(req.path).to.equal('/bar');
          next();
        };
        ...
        router.handle(request, response, function (err) {
          testsrctest__expect(count).to.equal(1);
          testsrctest__expect(request.path).to.equal('/foo/bar');
        });
      });
    ...
    describe('param()', function () {
      it('should register simple param processing', function () {
        ...
        router.use('/:foo', function (req, res, next) {
          testsrctest__expect(res.foo).to.equal('bar');
          next();
        });
        router.handle(request, response, function (err) {
          testsrctest__expect(param).to.equal('bar');
        });
      });
  ...
  describe('Application', function () {
    describe('set/get', function () {
      it('should allow storage/retrieval of objects by key', function () {
        ...
        app.set('foo', 'bar');
        app.set('fooObj', foo);
        testsrctest__expect(app.get('fooObj').foo).to.equal('bar');
        testsrctest__expect(app.get('foo')).to.equal('bar');
      });
    });
    ...
    describe('use()', function () {
      it('should register a simple middleware function', function () {
        ...
        app.use(fn);
        testsrctest__expect(app._router.stack[0].regexp.exec('/')).to.exist;
        testsrctest__expect(app._router.stack[0]).to.have.property('fn', fn);
      });
      it('should register a simple middleware function at a specified path', function () {
        var app = testsrctest__express();
        var fn = function fn(req, res, next) {};
        ...
        app.use(path, fn);
        testsrctest__expect(app._router.stack[0].regexp.exec(path)).to.exist;
        testsrctest__expect(app._router.stack[0]).to.have.property('fn', fn);
      });
      it('should register multiple middleware functions at a specified path', function () {
        var app = testsrctest__express();
        ...
        testsrctest__expect(app._router.stack[0].regexp.exec(path)).to.exist;
        testsrctest__expect(app._router.stack[0]).to.have.property('fn', fn1);
        testsrctest__expect(app._router.stack[1].regexp.exec(path)).to.exist;
        testsrctest__expect(app._router.stack[1]).to.have.property('fn', fn2);
      });
    });
    ...
    describe('reload()', function () {
      ...
      it('should reload app and reset request state', function () {
        ...
        testsrctest__expect(response.req.params).to.eql(null);
        testsrctest__expect(count).to.equal(2);
      });
    });
  ...
  describe('History', function () {
    describe('handle()', function () {
      ...
      it('should handle encoded urls', function () {
        ...
        testsrctest__expect(historyApp.history.current).to.eql(url);
      });
      it('should store encoded previous history in cache', function () {
        ...
        testsrctest__expect(cache).to.have.key(url);
        testsrctest__expect(cache[url].req.originalUrl).to.eql(url);
        testsrctest__expect(cache[url].req.path).to.eql(url);
        testsrctest__expect(cache[url].req.url).to.eql(url);
      });
    });
  });
  ...
  describe('response', function () {
    ...
    describe.skip('cookie()', function () {
      ...
      it('should set multiple cookies', function () {
        ...
        testsrctest__expect(document.cookie).to.eql('foo=bar; boo=bat');
      });
    });
  });
  ...
  describe('request', function () {
    ...
    describe('parse', function () {
      ...
      it('should parse both query params and hash fragments', function () {
        ...
        testsrctest__expect(request.query).to.eql({ q: 'foo' });
        testsrctest__expect(request.hash).to.eql({ fav: '123,456', visit: '789' });
        testsrctest__expect(request.url).to.eql('http://www.yr.no/en/search?q=foo');
      });
    });
  });
});
