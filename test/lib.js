...
require.register('lib/layer.js', function(require, module, exports) {
    'use strict';
...
require.register('lib/router.js', function(require, module, exports) {
    'use strict';
    ...
    var assign = require('object-assign/index.js#3.0.0'),
...
require.register('lib/response.js', function(require, module, exports) {
    'use strict';
    ...
    var assign = require('object-assign/index.js#3.0.0'),
        _cookie = require('cookie/index.js#0.1.3'),
...
require.register('strict-uri-encode/index.js#1.0.2', function(require, module, exports) {
    'use strict';
...
require.register('query-string/index.js#2.4.0', function(require, module, exports) {
    'use strict';
    var strictUriEncode = require('strict-uri-encode/index.js#1.0.2');
...
require.register('cookie/index.js#0.1.3', function(require, module, exports) {
    /*!    
     * cookie    
...
require.register('lib/request.js', function(require, module, exports) {
    'use strict';
    ...
    var assign = require('object-assign/index.js#3.0.0'),
        cookie = require('cookie/index.js#0.1.3'),
        Emitter = require('eventemitter3/index.js#1.1.1'),
        qsParse = require('query-string/index.js#2.4.0').parse,
        urlUtils = require('@yr/url-utils/index.js#2.1.0');
...
require.register('@yr/runtime/index.js#0.1.0', function(require, module, exports) {
...
require.register('@yr/url-utils/index.js#2.1.0', function(require, module, exports) {
    'use strict';
    
    var isServer = require('@yr/runtime/index.js#0.1.0').isServer,
...
require.register('lib/history.js', function(require, module, exports) {
    'use strict';
...
require.register('object-assign/index.js#3.0.0', function(require, module, exports) {
    'use strict';
