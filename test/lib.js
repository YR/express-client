...
_m_['@yr/url-utils/index.js#2.3.2']=(function(module,exports){
  module=this;exports=module.exports;
  ...
  var isServer = _m_['@yr/runtime/index.js#2.0.0'].isServer;
...
_m_['src/lib/layer.js']=(function(module,exports){
  ...
  var urlUtils = _m_['@yr/url-utils/index.js#2.3.2'];
...
_m_['eventemitter3/index.js#2.0.0']=(function(module,exports){
  module=this;exports=module.exports;
...
_m_['cookie/index.js#0.3.1']=(function(module,exports){
  module=this;exports=module.exports;
...
_m_['src/lib/response.js']=(function(module,exports){
  ...
  var assign = _m_['object-assign/index.js#4.1.0'];
  var _cookie = _m_['cookie/index.js#0.3.1'];
  var Emitter = _m_['eventemitter3/index.js#2.0.0'];
...
_m_['query-string/index.js#4.2.3']=(function(module,exports){
  module=this;exports=module.exports;

  'use strict';
  var strictUriEncode = _m_['strict-uri-encode/index.js#1.1.0'];
  var objectAssign = _m_['object-assign/index.js#4.1.0'];
...
_m_['src/lib/request.js']=(function(module,exports){
  ...
  var cookie = _m_['cookie/index.js#0.3.1'];
  var Emitter = _m_['eventemitter3/index.js#2.0.0'];
  var qsParse = _m_['query-string/index.js#4.2.3'].parse;
  var urlUtils = _m_['@yr/url-utils/index.js#2.3.2'];
