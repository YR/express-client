...
var matcher = require('path-to-regexp/index.js#1.2.1'),
    urlUtils = require('@yr/url-utils/index.js#2.0.4');
...
var Response = (function (_Emitter) {
  ...
  */
	...
	Response.prototype.send = function send() {
		...
		this.status(200);
		this.finished = true;
		_Emitter.prototype.emit.call(this, 'finish');
	};
...
var Request = (function (_Emitter) {
  ...
  */
	...
	Request.prototype.abort = function abort() {
		this.reset();
		_Emitter.prototype.emit.call(this, 'close');
	};
...
const isServer = require('@yr/runtime/index.js#0.1.0').isServer
